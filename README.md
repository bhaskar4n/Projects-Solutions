...
**Address Book** - Keep track of various contacts, their numbers, emails and little notes about them like a Rolodex in the database.[[bhaskaran(Python)]](https://github.com/bhaskar4n/address-book-database)
